...
.controller('LobbyCtrl',['$scope', '$state', '$ionicHistory', 'ServerQuestionService', 'TKQuestionsService', 'UserService','$window', 
function($scope, $state, $ionicHistory, ServerQuestionService, TKQuestionsService, UserService, $window) {
